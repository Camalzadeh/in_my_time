    ...
    <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs text-slate-500">{targetDates.length} selected</span>
                  </div>
      ...
      {showSuccess && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl shadow-xl text-center w-[320px] animate-fadeIn">
            <h2 className="text-2xl font-bold mb-2">🎉 Congratulations!</h2>
            <p className="mb-4">Your poll has been successfully created.</p>
